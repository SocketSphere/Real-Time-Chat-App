  ...
  const location=useLocation();
   const handleScrollToPricing = () => {
    if (location.pathname === "/") {
      ...
      // Navigate to home page with state to scroll
    ...
    <nav className="navbar bg-white shadow-md px-4 sticky top-0 z-50 md:px-8">
      ...
      <div className="hidden lg:flex navbar-center">
        <ul className="menu menu-horizontal px-1 gap-2 text-gray-700 font-medium">
          ...
          <li><button href="#pricing" className="hover:text-blue-600" onClick={handleScrollToPricing}>Pricing</button> </li>


          {/* <li><Link to="#pricing" className="hover:text-blue-600">Price</Link></li> */}
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          {/* sign up */}
          <button className="m-3 p-1 rounded-md btn-ghost ">
